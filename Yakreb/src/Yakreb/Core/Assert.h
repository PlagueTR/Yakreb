...
#include "Yakreb/Core/ConfigMacros.h"
	...
	#define YGE_CORE_ASSERT_TAGGED(condition, tag, ...) { if(!(condition)){ ::Yakreb::Log::PrintMessage(::Yakreb::Log::Type::Core, ::Yakreb::Log::Level::Error, tag, "Assertion Failed: {0}", __VA_ARGS__); YGE_DEBUGBREAK; } }
	#define YGE_ASSERT_TAGGED(condition, tag, ...) { if(!(condition)){ ::Yakreb::Log::PrintMessage(::Yakreb::Log::Type::Client, ::Yakreb::Log::Level::Error, tag, "Assertion Failed: {0}", __VA_ARGS__); YGE_DEBUGBREAK; } }
	...
	#define YGE_CORE_ASSERT_TAGGED(condition, tag, ...) { if(!(condition)){ ::Yakreb::Log::PrintMessage(::Yakreb::Log::Type::Core, ::Yakreb::Log::Level::Error, tag, "Assertion Failed: {0}", __VA_ARGS__); } }
	#define YGE_ASSERT_TAGGED(condition, tag, ...) { if(!(condition)){ ::Yakreb::Log::PrintMessage(::Yakreb::Log::Type::Client, ::Yakreb::Log::Level::Error, tag, "Assertion Failed: {0}", __VA_ARGS__); } }
...
#else
	#define YGE_CORE_ASSERT_TAGGED(condition, tag, ...)
	#define YGE_ASSERT_TAGGED(condition, tag, ...)
